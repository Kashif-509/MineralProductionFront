...
const MineralRevenueTable = () => {
  ...
  const minerals = [
    { name: "Argillaceous_clay (LSM)", icon: "⛏️" },
    { name: "Bauxite", icon: "⛏️" },
    { name: "Bentonite", icon: "🛠️" },
    { name: "Brine (LSM)", icon: "⛏️" },
    { name: "Coal", icon: "⛏️" },
    { name: "Coal_LSM", icon: "⛏️" },
    { name: "China_Clay", icon: "⛏️" },
    { name: "Dolomite", icon: "⛏️" },
    { name: "Fireclay", icon: "⛏️" },
    { name: "Fuller_Earth", icon: "⛏️" },
    { name: "Gypsum", icon: "⛏️" },
    { name: "Gypsum_LSM", icon: "⛏️" },
    { name: "Iron_Ore", icon: "⚙️" },
    { name: "Limestone", icon: "⛏️" },
    { name: "Limestone_LSM", icon: "⛏️" },
    { name: "Latrite", icon: "⛏️" },
    { name: "Marble", icon: "⛏️" },
    { name: "Ochers", icon: "⛏️" },
    { name: "RockSalt", icon: "🧂" },
    { name: "RockSalt_LSM", icon: "🧂" },
    { name: "Silica_Sand", icon: "⛏️" },
    { name: "Silica_Sand_LSM", icon: "" },
    { name: "Ordinary_Salt", icon: "🧂" },
    { name: "Lake_Salt", icon: "🧂" },
    { name: "Sand_Gravel_LSM", icon: "⛏️" },
  ];
